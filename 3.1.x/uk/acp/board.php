...
$lang = array_merge($lang, array(
	...
	'BOARD_INDEX_TEXT'				=> 'Текст головної дошки',
	'GUEST_STYLE'					=> 'Стиль гостя',
	'SITE_HOME_TEXT'				=> 'Основний текст',
	'DISPLAY_LAST_SUBJECT'			=> 'Показувати заголовок найсвіжішого посту в списку форумів',
	'SITE_HOME_URL'					=> 'Основна адреса сайту',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_GRAVATAR'				=> 'Дозволити Gravatar',
));
...
$lang = array_merge($lang, array(
	...
	'LOAD_CPF_PM'					=> 'Відображення користувальницьких полів профілів в особистих повідомленнях',
	'READ_NOTIFICATION_EXPIRE_DAYS'	=> 'Терміну повідомлення для прочитання',
	'READ_NOTIFICATION_EXPIRE_DAYS_EXPLAIN' => 'Кількість днів, які треба для прочитання повідомлення інакше вони будуть автоматично видалені. Встановіть це значення в 0, щоб зробити повідомлення постійно видимими для прочитання.',
	'ALLOW_LIVE_SEARCHES'			=> 'Дозволити пошук',
	'ALLOW_LIVE_SEARCHES_EXPLAIN'	=> 'Якщо цей параметр включений, користувачі отримують пропозиції ключовим словом, як вони введуть в деяких областях по всьому форуму.',
));

// Contact Settings
$lang = array_merge($lang, array(
	'ACP_CONTACT_SETTINGS_EXPLAIN'		=> 'Тут можна здійснити операції над сторінкою контактів.',

	'CONTACT_US_ENABLE'				=> 'Активувати контакт сторінку',
	'CONTACT_US_ENABLE_EXPLAIN'		=> 'This page allows users to send emails to board administrators',

	'CONTACT_US_INFO'				=> 'Інформація про контакт',
	'CONTACT_US_INFO_EXPLAIN'		=> 'Інформація для показу на сторінці контакту',
	'CONTACT_US_INFO_PREVIEW'		=> 'Контактна інформація - Попередній перегляд',
	'CONTACT_US_INFO_UPDATED'		=> 'Контактна інформація була оновлена.',
));
...
$lang = array_merge($lang, array(
	...
	'USE_SYSTEM_CRON'		=> 'Запускати періодичні завдання з системоного CRON',
	...
	'MOD_REWRITE_ENABLE'		=> 'Активувати URL Rewriting',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_PASSWORD_RESET_EXPLAIN'	=> 'Визначає чи користувач має змогу бачити "Я не памятаю свій пароль" на сторінці входу для відновлення паролю. Якщо використовується сторонній механізм входу то ця опція може бути вимкнена.',
